...
namespace SUIFW
{
    ...
    internal static class SysDefine
    {
        ...
        public const string SYS_PATH_CNLauguageJson = "SUIFW/LauguageJSONConfig";
        public const string SYS_PATH_SysConfigJson = "SUIFW/SysConfigInfo";
        public const string SYS_PATH_UIFormConfigJson = "SUIFW/UIFormsConfigInfo";
